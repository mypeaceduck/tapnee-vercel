const Logo = ({ opacity }: { opacity: number }) => {
  return (
    <svg
      version="1.0"
    ...
    >
      <defs>
        <linearGradient
          ...
          y2="3240"
        >
          <stop offset="0%" style={{ stopColor: "#d16ba5" }} />
          <stop offset="100%" style={{ stopColor: "#face9b" }} />
        </linearGradient>
      </defs>
      ...
      >
        <path
          d="M4554 8060 c-155 -23 -260 -131 -283 -292 -5 -35 -10 -621 -10 -1327
...
-262 208 -36 6 -67 10 -70 10 -3 -1 -28 -5 -56 -9z"
        />
        <path
          d="M6659 6017 c-108 -31 -180 -97 -216 -200 -17 -48 -18 -100 -18 -682
...
-26 56 c-54 114 -157 180 -289 186 -41 1 -96 -3 -121 -10z"
        />
        <path
          d="M2204 4821 c-92 -25 -157 -58 -217 -111 -59 -52 -87 -105 -87 -165 0
